...
## Quant parity
4-bit across runtimes (GGUF `Q4_K_M` ≈ MLX 4-bit; gpt-oss uses native MXFP4). Quant schemes differ slightly between runtimes, which is *why* both are measured — quality is not assumed to transfer.
